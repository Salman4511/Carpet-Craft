...
TextStyle textstyle1 =
    const TextStyle(fontSize: 30, fontWeight: FontWeight.w700, color: kwhite);
...
TextStyle textstyle12 =
    const TextStyle(fontWeight: FontWeight.w900, fontSize: 15, color: kblack);
...
SizedBox kwidth18 = const SizedBox(
  width: 18,
);
